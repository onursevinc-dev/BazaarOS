...
import { CldImage, CldUploadWidget, cloudinaryLoader } from "next-cloudinary";
...
interface ImageUploadProps {
  ...
  value: string[];
  type: "standart" | "profile" | "cover";
  donstShowPreview?: boolean;
...
const ImageUpload: FC<ImageUploadProps> = ({
  ...
  if (type === "profile") {
    return (
      <div className="relative rounded-full w-52 h-52 inset-x-96 bg-gray-200 border-white shadow-2xl">
        {value.length > 0 && (
          <Image
            src={value[0]}
            alt={""}
